...
const whatIDo = [
	{
		name: <><h4>Frontend</h4><div>React & Next.js & Preact</div><div>Bootstrap</div></>,
		img: "../../assets/whatIDo/005-landing-page.png",
		scale: 1.2
	},
	{
		name: <><h4>Backend</h4><div>Node.js & Deno</div><div>Ruby on Rails</div></>,
		img: "../../assets/whatIDo/006-development.png",
		scale: 1.2
	},
	{
		name: <><h4>Mobile</h4><div>React Native</div><div>Native Android</div><div>Cordova / PhoneGap</div></>,
		img: "../../assets/whatIDo/007-app-development.png",
		scale: 1.2
	},
	{
		name: <><h4>Database</h4><div>PostgreSQL</div><div>MySQL</div><div>S3 Buckets</div></>,
		img: "../../assets/whatIDo/003-cloud.png",
		scale: 1.2
	},
	{
		name: <><h4>DevOps</h4><div>Docker</div><div>Git</div><div>Agile Development</div></>,
		img: "../../assets/whatIDo/009-project.png",
		scale: 1.2
	},
	{
		name: <><h4>Design</h4><div>Modern Web-Design</div><div>Adobe Creative Cloud</div></>,
...
const skills = [
	...
	{
		name: <>Adobe Creative Cloud<br />(Illustrator, Photoshop, InDesign)</>,
	...
	return (
		<>
			<div className={S.wrapper}>
				{whatIDo.map((skill, i) => <SkillBox {...skill} key={i} />)}
			</div>
			<hr />
			<div className={S.wrapper}>
				{skills.map((skill, i) => <SkillBox {...skill} key={i} />)}
			</div>
		</>
	);
}
