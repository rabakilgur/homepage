			...
			<div className="container mx-auto" style={{ maxWidth: 1000, paddingInline: "1.2rem" }}>
				<section className="section" id="about">
					...
					<p style="max-width: 65ch; text-align: center; margin: 0 auto 1em auto; line-height: 1.9;">
						Hallo! Ich bin Robin, ein Softwareingenieur aus Darmstadt. Ich beschäftige mich hauptsächlich mit Frontend- und Fullstack-Entwicklung, arbeite aber auch häufig an anderen Projekten;
						zum Beispiel in den Bereichen App-Entwicklung oder APIs. Weiter unten sind ein paar meiner (Hobby-)Projekte verlinkt. Hier ist eine Übersicht über die Bereiche in denen ich tätig bin
						und einige Technologien die ich in letzter Zeit benutze:
					</p>
				...
				<section className="section" id="projects">
					...
					<ProjectCard color="orange" image="assets/proj/proj_RobotControlGUI.jpg" link="https://github.com/rabakilgur/ThorRobotGUI" right>
						...
						<ProjectCard.Description
							text={
								<>
									Zusammen mit dem FabLab Darmstadt habe ich den 3D-gedruckten Open-Source 6-Achsen-Roboter <i>Thor</i> gebaut und modifiziert. Um ihn anzusteuern habe ich das{" "}
									<i>Thor Robot GUI</i> geschrieben: Eine Electron App mit der man den Roboter präsize steuern kann.
								</>
							}
						/>
					...
					<ProjectCard color="grey" image="assets/proj/proj_OPCFactoryControlPanel.jpg" link="https://github.com/rabakilgur/OPC_Factory_Control_Panel" right>
						...
						<ProjectCard.Description
							text={
								<>
									Im Rahmen meines Bachelorpraktikums am Institut <i>Datenverarbeitung in der Konstruktion</i> habe ich mit Kommolitonen ein Programm geschrieben um Aufträge dynamisch an
									industrielle Maschinen zu senden, das leicht zu benutzen und schnell um Maschinentypen zu erweitern ist.
								</>
							}
						/>
