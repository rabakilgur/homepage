var word = document.getElementById('bubble2');
...
var swap = function() {
  ...
  if(timer < 25) {
    ...
    word.innerHTML = "Mein Name ist Robin Garbe. Ich bin Web Designer und Developer.";
    word.dataset.text = "Mein Name ist Robin Garbe. Ich bin Web Designer und Developer.";
  }
}
swap();